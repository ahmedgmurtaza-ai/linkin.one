            ...
            <CardContent className="prose prose-gray dark:prose-invert max-w-none pt-6">
              <section className="space-y-6">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-medium mb-2 mt-4">3.2 Username Policy</h3>
                  <p className="text-muted-foreground">
                    Usernames must not:
                  </p>
                  <ul className="list-disc pl-6 space-y-1 text-muted-foreground mt-2">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-medium mb-2 mt-4">4.1 Your Responsibilities</h3>
                  ...
                  <h3 className="text-xl font-medium mb-2 mt-4">4.2 License to Your Content</h3>
                  <p className="text-muted-foreground">
                ...
                <div>
                  <h2 className="text-2xl font-semibold mb-3">7. Analytics and Tracking</h2>
                  <p className="text-muted-foreground">
