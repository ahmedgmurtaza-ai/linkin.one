...
export function LinkCard({ link, compact = false }: LinkCardProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className={`w-full flex items-center gap-3 bg-linear-to-r from-card/80 to-primary/5 hover:from-primary/10 hover:to-accent/15 rounded-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg shadow-sm group ${
